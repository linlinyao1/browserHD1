...
- (void)easyTableView:(EasyTableView *)easyTableView selectedView:(UIView *)selectedView atIndexPath:(NSIndexPath *)newIndexPath deselectedView:(UIView *)deselectedView AtIndexPath:(NSIndexPath*)oldIndex;
